  ...
  return (
    <div className="container mx-auto p-6 flex justify-center items-center min-h-screen animate-fade-in">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 lg:p-12 transform hover:scale-105 transition-transform duration-300">
        <h3 className="text-3xl font-bold text-gray-800 mb-6 text-center">Login to Your Account</h3>
        {error && (
        ...
        <form onSubmit={submit}>
          <div className="mb-4">
            ...
            <div className="relative">
              <FaUserCircle className="absolute left-4 top-1/2 -translate-y-1/2 text-deep-gray" />
              <input
          ...
          <div className="flex items-center justify-between">
            <button
              className="w-full flex items-center justify-center space-x-2 bg-primary-blue hover:bg-accent-teal text-white font-bold py-3 px-4 rounded-full shadow-lg focus:outline-none focus:shadow-outline transition-all duration-200 transform hover:scale-105 active:scale-95"
              type="submit"
            >
              <FaSignInAlt />
              <span>Login</span>
